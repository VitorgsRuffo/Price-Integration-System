<%-- 
    Document   : footer
    Created on : Feb 9, 2022, 8:36:53 PM
    Author     : wellinton
--%>
...
<html>
    ...
    <body>
        <div class="container-fluid m-0 p-0 position-absolute bottom-0">
            <div class="footer w-100 px-4 py-2 d-flex justify-content-between align-items-center bg-success">
                ...
                <div class="d-flex flex-column justify-content-center align-items-end">
                    <p class="text-white m-1 ">Estudo de caso desenvolvido por:</p>
                    <p class="text-white m-0">Vitor Gabriel da Silva Ruffo</p>
                    <p class="text-white m-1">Wellinton Piassa</p>
                </div>
            </div>    
        </div>
    </body>
