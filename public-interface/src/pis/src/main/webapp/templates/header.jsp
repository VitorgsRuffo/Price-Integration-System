...
<html>
  ...
  <body id="header">
        <div class="container-fluid col-12 d-flex bg-dark">
            <div class="col-3 d-flex align-items-center justify-content-center title">
            ...
            <div class="col-6 d-flex align-items-center justify-content-center">
                <form class="form w-100 d-flex align-items-center justify-content-center " action="${pageContext.servletContext.contextPath}/search" method="GET">
                    <div class="form-group w-75">
                        <label class="control-label" for="q"></label>
                        <input id="search-bar" class="form-control" type="text" name="q" placeholder="Qual modelo deseja ver?" autofocus/>
